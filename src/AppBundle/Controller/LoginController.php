...
class LoginController extends BaseController
{
    ...
    public function loginAction(request $request)
    {
        ...
        $formFactory = $this->get('fos_user.security.login_manager');
        ...
        $eventDispatcher->dispatch(FOSUserEvents::SECURITY_IMPLICIT_LOGIN, $event);
        ...
        return $this->render('enregistrement/login.html.twig', array(
